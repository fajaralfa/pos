                ...
                <table class="table-fixed">
                    ...
                    <tbody>
                        <tr v-for="item in semuaBarang" :key="item.id">
                            ...
                            <td>{{ item.harga }}</td>
                            <td>
                                <SecondaryButton @click.prevent="emitBarang(item)">Select</SecondaryButton>
                            </td>
                        </tr>
                    </tbody>
                </table>
